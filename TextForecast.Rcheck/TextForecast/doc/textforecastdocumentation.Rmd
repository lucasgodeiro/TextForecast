...
```{r get words example, results = "hide",eval=FALSE}
...
```{r get collocations example, results = "hide",eval=FALSE}
library(TextForecast)
st_year=2017
end_year=2018
path_name=system.file("news",package="TextForecast")
...
```{r get terms example, results = "hide", eval=FALSE}
library(TextForecast)
st_year=2017
end_year=2018
path_name=system.file("news",package="TextForecast")
...
```{r optimal alphas example, results = "hide"}
library(TextForecast)
 set.seed(1)
 data("stock_data")
 data("news_data")
...
```{r tv dictionary example, results = "hide"}
 library(TextForecast)
 set.seed(1)
 data("stock_data")
 data("news_data")
...
``` {r optimal factor example, results = "hide"}
library(TextForecast)
data("optimal_x")
...
``` {r Text Forecast Example, results = "hide"}
library(TextForecast)
set.seed(1)
data("stock_data")
y=as.matrix(stock_data[,2])
...
## Example 
``` {r Text Nowcast Example, results = "hide"}
 library(TextForecast)
 set.seed(1)
 data("stock_data")
  data("news_data")
...
``` {r Top Terms Example, results = "hide"}
library(TextForecast)
 set.seed(1)
 data("stock_data")
 data("news_data")
...
``` {r TV sentiment index example, results = "hide", eval=FALSE}
library(TextForecast)
 set.seed(1)
 data("stock_data")
 data("news_data")
