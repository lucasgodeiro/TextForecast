...
**ntrms:** maximum numbers of words  that will be filtered by tf-idf. We rank the word by tf-idf in a decreasing order. Then, after we 
select the words with the ntrms highst tf-idf.
